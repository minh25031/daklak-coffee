...
import { Search, Plus, Star, User, Calendar, Eye, Edit, BarChart3 } from "lucide-react";
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          <PageTitle
            ...
            subtitle="Theo dõi và quản lý đánh giá chất lượng các lô sơ chế cà phê"
          />
          <Button
            onClick={() => router.push("/dashboard/farmer/processing/processing-batch-evaluations/create")}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 font-medium">Tổng đánh giá</p>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="p-6 border-b border-gray-100">
                <h2 className="text-xl font-semibold text-gray-800">Danh sách đánh giá lô sơ chế</h2>
                <p className="text-gray-600 mt-1">Hiển thị {filtered.length} trong tổng số {data.length} đánh giá</p>
              </div>
              ...
              {loading ? (
                ...
                <div className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-700 mb-2">Không tìm thấy đánh giá nào</h3>
                  <p className="text-gray-500">Thử thay đổi từ khóa tìm kiếm hoặc thêm đánh giá mới.</p>
                </div>
              ) : (
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    {filtered.map((evaluation) => (
                      <div
                        ...
                        className="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 hover:border-yellow-300 transition-all duration-300 hover:shadow-lg group"
                      >
                        <div className="p-6">
                          <div className="flex items-start justify-between mb-4">
                            <div className="flex-1">
                              <h3 className="font-semibold text-gray-900 text-lg mb-2">
                                {evaluation.batchCode}
                              </h3>
                          ...
                          <div className="space-y-3">
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                              ...
                              <span className="font-semibold text-yellow-600">{evaluation.score}/10 điểm</span>
                            </div>
                            ...
                            {evaluation.note && (
                              <div className="flex items-start gap-2">
                                ...
                                <p className="text-sm text-gray-600 leading-relaxed">
                                  {evaluation.note.length > 50 
                                    ? `${evaluation.note.substring(0, 50)}...` 
                                    : evaluation.note}
                                </p>
                              </div>
                            )}
                            ...
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                             ...
                             <Button
                               ...
                               onClick={() => router.push(`/dashboard/farmer/processing/processing-batch-evaluations/${evaluation.evaluationId}`)}
                             >
                             ...
                             <Button
                               ...
                               onClick={() => router.push(`/dashboard/farmer/processing/processing-batch-evaluations/${evaluation.evaluationId}/edit`)}
                             >
