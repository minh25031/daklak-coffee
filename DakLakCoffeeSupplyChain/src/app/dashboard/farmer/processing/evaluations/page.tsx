    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
      <div className="p-6 max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          <PageTitle
            title="Quản lý đánh giá sơ chế"
            subtitle="Theo dõi và quản lý đánh giá chất lượng sơ chế cà phê"
          />
          <Button
            onClick={() => router.push("/dashboard/farmer/processing/evaluations/create")}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    {filtered.map((evaluation) => (
                      <div
                        ...
                        className="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-gray-200 hover:border-yellow-300 transition-all duration-300 hover:shadow-lg group flex flex-col h-full"
                      >
                        <div className="p-6 flex flex-col h-full">
                          ...
                          <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-100">
                            <Button
                              ...
                              onClick={() => router.push(`/dashboard/farmer/processing/evaluations/${evaluation.evaluationId}`)}
                            >
                            ...
                            <Button
                              ...
                              onClick={() => router.push(`/dashboard/farmer/processing/evaluations/${evaluation.evaluationId}/edit`)}
                            >
