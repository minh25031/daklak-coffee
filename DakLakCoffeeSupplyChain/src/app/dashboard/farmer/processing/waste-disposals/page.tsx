...
import { Search, Plus, Trash, Recycle, Scale, Calendar, Eye, Edit } from "lucide-react";
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          <div className="space-y-2">
            ...
            <p className="text-gray-600">Theo dõi và quản lý việc xử lý chất thải từ quá trình sơ chế</p>
          </div>
          <Button
            onClick={() => router.push("/dashboard/farmer/processing/waste-disposals/create")}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 font-medium">Tổng xử lý</p>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 font-medium">Tái chế</p>
                <p className="text-2xl font-bold text-orange-600">
                  {data.filter(item => 
                    item.disposalMethod?.toLowerCase().includes('tái chế') || 
                    item.disposalMethod?.toLowerCase().includes('recycle')
                  ).length}
                </p>
              </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="p-6 border-b border-gray-100">
                <h2 className="text-xl font-semibold text-gray-800">Danh sách xử lý chất thải</h2>
              ...
              {loading ? (
                ...
                <div className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-700 mb-2">Không tìm thấy dữ liệu nào</h3>
                        ...
                        <div className="p-6 flex flex-col h-full">
                          ...
                          <div className="space-y-3 flex-grow">
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                              ...
                              <span>{item.revenue} {item.unit}</span>
                            </div>
                          ...
                          <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-100">
                            <Button
                              ...
                              onClick={() => router.push(`/dashboard/farmer/processing/waste-disposals/${item.disposalId}`)}
                            >
                            ...
                            <Button
                              ...
                              onClick={() => router.push(`/dashboard/farmer/processing/waste-disposals/${item.disposalId}/edit`)}
                            >
